...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Bitcoinfiat Core bitcoinfiat-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bitcoinfiat-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitcoinfiat transaction") + "\n" +
                               "  bitcoinfiat-tx [options] -create [commands]   " + _("Create hex-encoded bitcoinfiat transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitcoinfiat transaction
