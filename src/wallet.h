...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT25000IFMN = 3,
    ONLY_NONDENOMINATED_NOT25000IFMN = 4, // ONLY_NONDENOMINATED and not 25000 DEV at the same time
...
enum ZerocoinSpendStatus {
    ...
    ZDEV_TXMINT_GENERAL = 9,                        // General errors in MintToTxIn
...
public:
    ...
    */
    ...
    CzDEVWallet* zwalletMain;

    bool fFileBacked;
    bool fWalletUnlockAnonymizeOnly;
    std::string strWalletFile;
    bool fBackupMints;
    std::unique_ptr<CzDEVTracker> zdevTracker;
    ...
    {
        zwalletMain = zwallet;
        zdevTracker = std::unique_ptr<CzDEVTracker>(new CzDEVTracker(strWalletFile));
    }

    CzDEVWallet* getZWallet() { return zwalletMain; }
