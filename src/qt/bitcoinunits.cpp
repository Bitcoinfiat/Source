...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case DEV:
        return QString("bitcoinfiat");
    case mDEV:
        return QString("mbitcoinfiat");
    case uDEV:
        return QString::fromUtf8("ubitcoinfiat");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case DEV:
            return QString("tDEV");
        case mDEV:
            return QString("mtDEV");
        case uDEV:
            return QString::fromUtf8("μtDEV");
        default:
            return QString("???");
        }
    }
