...
/** Utility functions used by the Bitcoinfiat Qt UI.
 */
namespace GUIUtil
{
...
// Render Bitcoinfiat addresses in monospace font
...
// Parse "bitcoinfiat:" URI into recipient object, return true on successful parsing
