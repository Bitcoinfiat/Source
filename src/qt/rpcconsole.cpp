                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzDEVPathCustom = GetArg("-zdevbackuppath", "");
    ...
    if(!strzDEVPathCustom.empty()) {
        ui->wallet_customzdevbackuppath->setText(QString::fromStdString(strzDEVPathCustom));
        ui->wallet_customzdevbackuppath_label->setVisible(true);
        ui->wallet_customzdevbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzDEVPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Bitcoinfiat RPC console.") + "<br>" +
