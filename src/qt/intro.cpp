...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Bitcoinfiat Core"),
     ...
     * override -datadir in the bitcoinfiat.conf file in the default data directory
     * (to be consistent with bitcoinfiatd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
