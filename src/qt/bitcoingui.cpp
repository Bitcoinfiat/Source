                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Bitcoinfiat Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Bitcoinfiat address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bitcoinfiat: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zDEV"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Bitcoinfiat Core"), this);
    aboutAction->setStatusTip(tr("Show information about Bitcoinfiat Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Bitcoinfiat"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Bitcoinfiat addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Bitcoinfiat addresses"));
    ...
    openAction->setStatusTip(tr("Open a Bitcoinfiat: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Bitcoinfiat Core help message to get a list with possible Bitcoinfiat command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Bitcoinfiat Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Bitcoinfiat network", "", count));
}
...
{
    QString strTitle = tr("Bitcoinfiat Core"); // default title
