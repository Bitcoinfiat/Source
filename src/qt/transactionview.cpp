 ...
 */
    ...
    typeWidget->addItem(tr("Minted"), TransactionFilterProxy::TYPE(TransactionRecord::StakeMint) | TransactionFilterProxy::TYPE(TransactionRecord::StakeZDEV));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zDEV"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zDev));
