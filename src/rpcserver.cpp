...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Bitcoinfiat server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Bitcoinfiat server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Bitcoinfiat features */
        {"bitcoinfiat", "masternode", &masternode, true, true, false},
        {"bitcoinfiat", "listmasternodes", &listmasternodes, true, true, false},
        {"bitcoinfiat", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bitcoinfiat", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bitcoinfiat", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"bitcoinfiat", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"bitcoinfiat", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"bitcoinfiat", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bitcoinfiat", "masternodedebug", &masternodedebug, true, true, false},
        {"bitcoinfiat", "startmasternode", &startmasternode, true, true, false},
        {"bitcoinfiat", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bitcoinfiat", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bitcoinfiat", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bitcoinfiat", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bitcoinfiat", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bitcoinfiat", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bitcoinfiat", "mnbudget", &mnbudget, true, true, false},
        {"bitcoinfiat", "preparebudget", &preparebudget, true, true, false},
        {"bitcoinfiat", "submitbudget", &submitbudget, true, true, false},
        {"bitcoinfiat", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bitcoinfiat", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bitcoinfiat", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bitcoinfiat", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bitcoinfiat", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bitcoinfiat", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bitcoinfiat", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bitcoinfiat", "checkbudgets", &checkbudgets, true, true, false},
        {"bitcoinfiat", "mnsync", &mnsync, true, true, false},
        {"bitcoinfiat", "spork", &spork, true, true, false},
        {"bitcoinfiat", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> bitcoinfiat-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:22617/\n";
}
