...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 22618;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Bitcoinfiat starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Bitcoinfiat: 1 day
        nTargetSpacing = 1 * 60;  // Bitcoinfiat: 1 minute
        nMaturity = 10;
        ...
        vSeeds.push_back(CDNSSeedData("seed1.bitcoinfiat.io", "seed1.bitcoinfiat.io"));              
        vSeeds.push_back(CDNSSeedData("seed2.bitcoinfiat.io", "seed2.bitcoinfiat.io"));
        vSeeds.push_back(CDNSSeedData("seed3.bitcoinfiat.io", "seed3.bitcoinfiat.io"));           
	vSeeds.push_back(CDNSSeedData("seed4.bitcoinfiat.io", "seed4.bitcoinfiat.io"));           
	vSeeds.push_back(CDNSSeedData("seed5.bitcoinfiat.io", "seed5.bitcoinfiat.io"));           
...
public:
    CTestNetParams()
    {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "bitcoinfiat-testnet.seed.fuzzbawls.pw"));
        //vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "bitcoinfiat-testnet.seed2.fuzzbawls.pw"));
        //vSeeds.push_back(CDNSSeedData("s3v3nh4cks.ddns.net", "s3v3nh4cks.ddns.net"));
        //vSeeds.push_back(CDNSSeedData("192.168.100.2", "192.168.100.2"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 129); // Testnet bitcoinfiat addresses start with 't' or 'u'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 14);  // Testnet bitcoinfiat script addresses start with '6' or '7'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet bitcoinfiat BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x2a)(0x40)(0x71)(0xb0).convert_to_container<std::vector<unsigned char> >();
        // Testnet bitcoinfiat BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x2a)(0x40)(0x78)(0x47).convert_to_container<std::vector<unsigned char> >();
        // Testnet bitcoinfiat BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Bitcoinfiat: 1 day
        nTargetSpacing = 1 * 60;        // Bitcoinfiat: 1 minutes
