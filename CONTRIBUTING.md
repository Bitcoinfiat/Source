Contributing to Bitcoinfiat Core
============================

The Bitcoinfiat Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Bitcoinfiat Core project, and is not to be
confused with overall Bitcoinfiat Network Protocol consensus changes.

Whether a pull request is merged into Bitcoinfiat Core rests with the project merge
...
Patches that change Bitcoinfiat consensus rules are considerably more involved than
...
Where a patch set proposes to change the Bitcoinfiat consensus, it must have been
...
The project leader is the release manager for each Bitcoinfiat Core release.
