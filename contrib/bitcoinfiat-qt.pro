...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/bitcoinfiat-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/bitcoinfiat-cli.cpp \
           src/bitcoinfiat-tx.cpp \
           src/bitcoinfiat.cpp \
           src/db.cpp \
           ...
           src/qt/bitcoinfiat.cpp \
           src/qt/bitcoinfiatstrings.cpp \
...
RESOURCES += src/qt/bitcoinfiat.qrc src/qt/bitcoinfiat_locale.qrc

TRANSLATIONS += src/qt/locale/bitcoinfiat_bg.ts \
                src/qt/locale/bitcoinfiat_de.ts \
                src/qt/locale/bitcoinfiat_en.ts \
                src/qt/locale/bitcoinfiat_es.ts \
                src/qt/locale/bitcoinfiat_fi.ts \
                src/qt/locale/bitcoinfiat_fr.ts \
                src/qt/locale/bitcoinfiat_it.ts \
                src/qt/locale/bitcoinfiat_ja.ts \
                src/qt/locale/bitcoinfiat_pl.ts \
                src/qt/locale/bitcoinfiat_pt.ts \
                src/qt/locale/bitcoinfiat_ru.ts \
                src/qt/locale/bitcoinfiat_sk.ts \
                src/qt/locale/bitcoinfiat_sv.ts \
                src/qt/locale/bitcoinfiat_vi.ts \
                src/qt/locale/bitcoinfiat_zh_CN.ts \
                src/qt/locale/bitcoinfiat_zh_TW.ts
