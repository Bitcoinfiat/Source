...
In order to support loading of multiple wallets in bitcoinfiat-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bitcoinfiat.cpp.
...
Changes to bitcoinfiat.cpp
----------------------
bitcoinfiat.cpp is the entry point into bitcoinfiat-qt, and as such, will require some minor modifications to provide hooks for
