...
This mechanism has been integrated into Bitcore-Node-Bitcoinfiat which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/bitcoinfiat-coin/insight-api-bitcoinfiat#web-socket-api](https://github.com/bitcoinfiat-coin/insight-api-bitcoinfiat#web-socket-api) 
* API: [https://github.com/bitcoinfiat-coin/insight-api-bitcoinfiat#swifttx-transactions](https://github.com/bitcoinfiat-coin/insight-api-bitcoinfiat#swifttx-transactions) 
...
By default, the Bitcoinfiat Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Bitcoinfiat Core daemon:
